...
async function syncAppointments() {
  ...
  try {
    ...
    const groupCancelled = await clinikoFetchAll(
      'group_appointments/cancelled?per_page=' + PER_PAGE + '&updated_since=' + encodeURIComponent(lastSync),
      'group_appointments'
    );
    console.log('  Group active: ' + groupActive.length + ', Group cancelled: ' + groupCancelled.length);
    ...
    groupCancelled.forEach(a => { byId[a.id] = mapAppointment(a, true, apptTypeLookup, true); });
